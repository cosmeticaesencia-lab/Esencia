...
const FAQ_ITEMS: FAQItem[] = [
  {
    ...
    answer:
      "La mayoría de las usuarias empieza a notar menos caída entre la 3ra y 4ta semana. Para ver crecimiento visible se recomienda uso constante durante al menos 8 semanas.",
  },
  {
    id: "postpartum",
    question: "¿Sirve si tengo caída postparto?",
    answer:
      "Sí, es una etapa en la que muchas usuarias eligen Esencia. Si tenés dudas puntuales sobre tu caso, te recomendamos consultar con un profesional de la salud.",
  },
  {
    id: "greasy",
    question: "¿Engrasa el pelo?",
    answer:
      "No. La fórmula de Esencia es liviana, se absorbe rápido y no deja sensación de pelo pesado.",
  },
  {
    id: "dyed-hair",
