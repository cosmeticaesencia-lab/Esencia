...
const PRICING_SECTION_ID = "pricing-section-hombres";
...
export default function TrustSectionHombres() {
  return (
    <section className="w-full bg-[var(--h-primary-light)]/25 py-10 md:py-14">
        ...
        <div className="overflow-hidden rounded-3xl bg-white p-5 shadow-sm md:p-8 lg:p-10">
          <div className="grid grid-cols-1 items-center gap-8 md:grid-cols-[minmax(0,42%)_minmax(0,58%)] md:gap-10 lg:gap-12">
            ...
            <div className="flex flex-col gap-4 md:gap-5">
              <span className="inline-block w-fit rounded-full bg-[var(--h-primary)]/15 px-3 py-1 text-[11px] font-bold tracking-[0.16em] text-[var(--h-primary-dark)] md:text-xs">
                DESDE LA RAÍZ
              </span>
              ...
              <button
                ...
                className="w-full rounded-full bg-[var(--h-primary)] px-4 py-3.5 text-xs font-bold uppercase tracking-wide text-white shadow-sm transition-colors hover:bg-[var(--h-primary-dark)] sm:py-4 sm:text-sm md:w-auto md:px-8"
              >
