  ...
  return (
    <div id="pricing-section-hombres" className="flex w-full min-w-0 flex-col gap-3 md:gap-4">
      ...
      <motion.button
        ...
        onClick={onPurchase}
        className="w-full max-w-full rounded-full bg-[var(--h-primary)] px-3 py-3.5 text-xs font-bold uppercase tracking-wide text-white shadow-sm sm:py-4 sm:text-sm"
      >
