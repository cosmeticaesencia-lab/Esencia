...
export default function AnnouncementBarHombres() {
  return (
    <div
      className="relative overflow-hidden bg-[var(--h-primary)] py-1.5 text-[10px] font-medium uppercase tracking-wide text-white sm:py-2 sm:text-xs sm:tracking-wider"
