            ...
            {index < steps.length - 1 && (
              <div
                className={`mb-3 h-px w-4 sm:mb-4 sm:w-6 md:w-10 ${
                  step > number ? "bg-primary/40" : "bg-gray-200"
                }`}
              />
            )}
          </div>
    ...
    <div className="grid grid-cols-3 gap-1.5 sm:gap-2">
      {methods.map(({ id, label }) => {
        ...
        return (
          ...
          >
            {id === "visa" && (
              <PaymentMethodIcon method="visa" className="h-4 w-auto sm:h-5" />
            )}
            {id === "mastercard" && (
              <PaymentMethodIcon method="mastercard" className="h-5 w-auto sm:h-6" />
            )}
            {id === "mercadopago" && (
              <PaymentMethodIcon method="mercadopago" className="h-6 w-auto sm:h-7" />
            )}
            {id !== "mercadopago" && (
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex flex-col gap-2 pt-2">
                    <button
                      ...
                      className="w-full rounded-full bg-primary py-3.5 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:bg-primary-dark"
                    >
                      Continuar
                    </button>
                    <button
                ...
                <div className="space-y-4">
                    ...
                    {(
                      ...
                      <label key={field} className="block">
                        ...
                        <input
                          ...
                          className="w-full rounded-lg border border-gray-200 px-3 py-2.5 text-sm outline-none transition-colors focus:border-primary focus:ring-2 focus:ring-primary/20"
                        />
                        {field === "email" &&
                  ...
                  <div className="flex flex-col gap-2 pt-2">
                    <button
                      ...
                      className="w-full rounded-full bg-primary py-3.5 text-sm font-bold uppercase tracking-wide text-white transition-colors hover:bg-primary-dark disabled:cursor-not-allowed disabled:opacity-50"
                    >
                      Continuar
                    </button>
                    <button
